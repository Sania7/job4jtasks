...
public class OptionalOfNullable {
     ...
     *
     * Чтобы создать Optional в случае если есть null элементы можно
     * использовать метод Optional.ofNullable().
     ...
     * @param strings
     * @param value
     * @return задача, написать метод поиск строки среди списка.
     * В списке могут быть null элементы.
     * Чтобы обернуть найденное значение нужно использовать
     * Optional.ofNullable(). Для безопасной проверки можно использовать
     * Objects.equals(). Если что-то найдено,
     * нужно вернуть Optional из этого значения,
