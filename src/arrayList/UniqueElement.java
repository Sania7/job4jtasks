 ...
 * Если элемент не найден - метод возвращает -1.
 * Необходимо указать, что эти методы реализованы с помощью цикла for(),
 * поэтому применять эти методы внутри циклов, которые перебирают список, нежелательно,
 ...
 * Для это необходимо найти первый и последний индекс вхождения элемента. Если равны - значит элемент уникальный.
