 ...
 * 2. Если первая буква первой строки равна последней букве второй строки И последняя буква первой строки равна
 * первой букве второй строки - метод должен вернуть true.
...
public class PairsCharString {
    public static boolean check(String l, String r) {
        return l.isEmpty() && r.isEmpty() ? true : l.charAt(0) == r.charAt(r.length() - 1)
                && l.charAt(l.length() - 1) == r.charAt(0) ? true : false;
    }
}
